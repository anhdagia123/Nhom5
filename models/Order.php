...
class Oder extends BaseModel {
    public function all() {
        $sql = "SELECT o. *, fullname, email, address, phone WHERE oder o JOIN  users
    ...
    public function find($id) {
        $sql = "SELECT o. *, fullname, email, address, phone FROM oders o JOIN users u ON o.user_id = u.id WHERE o.id = :id";
        $stmt = $this->conn->prepare($sql);
